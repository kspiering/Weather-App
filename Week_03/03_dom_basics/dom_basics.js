...
document.querySelector("#display").innerText =
  "<span>Tony wants to know :</span> what the difference is.";

// Change the HTML content of an element

document.querySelector("p").innerHTML =
  '<script>console.log("Bad script")</script><span style="color:red">Tony wants to know :</span> what the difference is.';
